...
-- Curated from the class WeakAura packs supplied by Retreat.
...
-- Pyrolancer profile ---------------------------------------------------------
-- Combined from Nëw's Pyro Heal UI (g1d1f6fiC) and Ethan's Incineration
-- (PmCFQGkaL). Both packs load on the Pyromancer class; the learned-spell and
-- live-aura filters keep this profile build-aware without importing WeakAuras.
Curate("Pyromancer", "g1d1f6fiC", {
  main = {
    {name="Lava Shard", id=503233, aliases={"Icy Penance"}, trackCharges=true},
    {name="Eruption", id=800103, glowWhenAuraID={800103,804230}},
    {name="Firefall", id=801905, glowWhenAuraID={801905,520825}},
    {name="Destroyer's Maw", id=802107, glowWhenAuraID={502112,520825}},
    {name="Aspect's Blessing", id=802168, glowWhenAuraID={802168}},
    {name="Draconic Invocation", id=802119, glowWhenAuraID={802119}},
    {name="Fired Up!", id=704823, glowWhenAuraID={704823}},
    {name="Pyroclasm", id=520019, targetDebuff=true},
    {name="Meteor", id=500135, aliases={"Meteor"}, targetDebuff=true},
    {name="Essence of Malygos", id=802120, glowWhenAuraID={802120}},
    {name="Sunstrider Array", id=804230, glowWhenAuraID={804230}},
    {name="Ignis Ultimatus", id=680369, targetDebuff=true},
    {name="Kael's Command", id=800816, glowWhenAuraID={804230}},
    {name="Emberheart", id=680378},
    {name="Volcanic Shell", id=807622, aliases={"Volcanic Shell"}},
    {name="Firestorm", id=802791, targetDebuff=true},
    {name="Circle of Fire", id=997003, aliases={"Circle of Fire"}, targetDebuff=true},
  },
  utility = {
    {name="Lava Barrier", id=504380, aliases={"Inferno Barrier"}, category="defensive"},
    {name="Spellburn", id=800808, aliases={"SpellBurn"}, category="interrupt"},
    {name="Dragon Leap", id=807616, category="mobility"},
    {name="Flame Step", id=801911, category="mobility"},
    {name="Reborn from Ash", id=804231, category="defensive"},
    {name="Grace of Alexstrasza", id=802167, category="defensive"},
    {name="Neltharion's Resolve", id=520488, category="defensive"},
    {name="Supernova", id=803546, category="control"},
    {name="Gaze of Ysera", id=503229, category="interrupt"},
    {name="Cataclysm", id=520218, category="offensive", targetDebuff=true},
  },
  procs = {
    {name="Flamecasting", id=804301, auraID=804301, maxStacks=10},
    {name="Legacy of Deathwing", id=707217, auraID=520823},
    {name="Aspect of Eternity", id=520770, auraID=520927},
    {name="Superheated", id=681196, auraID=681196},
    {name="Eruption", id=800103, auraID=800103},
    {name="Sunstrider Array", id=804230, auraID=804230},
    {name="Essence of Malygos", id=802120, auraID=802120},
    {name="Fired Up!", id=704823, auraID=704823},
    {name="Ashen Skin", id=504720, auraID=504720},
    {name="Ember Skin", id=504707, auraID=504707},
    {name="Magma Skin", id=680387, auraID=680387},
    {name="Dragon Skin", id=681314, auraID=681314},
    {name="Leyline", id=355106, auraID=355106},
    {name="Arcane Artillery", id=968760, auraID=968760, aliases={"ArcArty"}},
    {name="Demonic Rune", id=24025, auraID=24025},
    {name="Ring Proc", id=900782, auraID=900782},
  },
  debuffs = {
    {name="Scorched", id=680962, auraID=680962, maxStacks=10},
    {name="Blaze", id=572160, auraID=572160},
    {name="Ignite", id=502029, auraID=502029, aliases={"Ignite"}},
    {name="Ignite (Alternate)", id=800791, auraID=800791, aliases={"Ignite"}},
    {name="Lava Shard", id=706874, auraID=706874},
    {name="Pyroclasm", id=520826, auraID=520826},
  },
})
...
do
  ...
  if database then
    database.source = "Wago-curated Pyrolancer HUD by Retreat"
    database.wagoPackIDs = {"g1d1f6fiC", "PmCFQGkaL"}
    database.wagoPackURLs = {"https://wago.io/g1d1f6fiC", "https://wago.io/PmCFQGkaL"}
    database.pyrolancerTalentID = 800796
    database.nativeResource = {
      title="HEAT",
      auraNames={"Heat", "Flames"},
      spellID=807389,
      harmfulAura=true,
      maximum=100,
      mode="bar",
      keepVisible=true,
      hideNativeOnAura=true,
