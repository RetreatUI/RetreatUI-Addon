...
-- Only verified runtime variants, the Oath Chain resource and active effects
-- are applied automatically. New actions remain data-only and Oaths are never
-- promoted into Main Rotation.
...
AddAudit({
  ...
  trackCooldown=true, source="Sidekick w_173c2281",
})
AddAudit({
...
database.templarSidekickAuditRevision = 3
database.templarSidekickSource = "w_173c2281"
database.templarAuditHUDPolicy = "data-only"
